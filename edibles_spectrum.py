...
class edibles_spectrum:
    '''
    This object will contain a spectrum from EDIBLES, and a set of methods to
    operate on the data.
    '''
...
if __name__ == "__main__":
    # Only activates when script run directly (i.e. not during imports)
    sp = edibles_spectrum("/data/DIBs/data/EDIBLES/DR3/FITS/HD170740/RED_860/HD170740_w860_n20_20140916_L.fits")
