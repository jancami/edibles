...
def initialize_gaussian(x, residuals, prefix='g0_'):
    ...
    Identifies the deepest local absorption dip in the residuals, estimates the
    width around it, and puts the result into a parameter dictionary mapped
    to bounded boundaries suitable for lmfit.
