...
#from edibles import PYTHONPATH
...
PYTHONPATH="/Users/oliverridge/PycharmProjects/EDIBLES"
EDIBLES_OUTPUTDIR="/Users/oliverridge/PycharmProjects/EDIBLES/Figures"
...
data_results = plotall(targets = listt, minrange=minrange, maxrange=maxrange, csv_name = f'{PYTHONPATH}/component_data/{csv_name}', c0=c0, c1=c1, model_v_shift=10.67, data_piece = data_piece, ContinuumMin = ContinuumMin, ContinuumMax = ContinuumMax, figpath=figpath)
