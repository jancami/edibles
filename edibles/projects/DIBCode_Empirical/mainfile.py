...
run_model_fitting(minrange=minrange, maxrange=maxrange, folder = "/Users/oliverridge/PycharmProjects/EDIBLES/component_data", csv_name = csv_name, removed_components=removed_components, recalibrated_wavelength=recalibrated_wavelength,coadded_flux=coadded_flux, coadd_SNR=coadd_SNR) # Change the folder component to your path that you want component data to go into
