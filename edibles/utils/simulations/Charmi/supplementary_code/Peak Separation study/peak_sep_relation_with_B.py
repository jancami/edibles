# -*- coding: utf-8 -*-
"""
Created on Wed Nov 23 20:47:47 2022
...
plt.plot(B005z02.iloc[:,0], B005z02.iloc[:,5], color = '#216a00', linewidth = 2, marker = 'o')
...
plt.plot(B005z04.iloc[:,0], B005z04.iloc[:,5], color = '#6fe415', linewidth = 2, marker = 'o')
...
plt.plot(B005z06.iloc[:,0], B005z06.iloc[:,5], color = '#5fc312', linewidth = 2, marker = 'o')
...
plt.plot(B005z08.iloc[:,0], B005z08.iloc[:,5], color = '#4fa30f', linewidth = 2, marker = 'o', label = 'B = 0.005 $cm^{-1}$')
...
plt.plot(B005z1.iloc[:,0], B005z1.iloc[:,5], color = '#4fa30f', linewidth = 2, marker = 'o')
...
plt.plot(B005z12.iloc[:,0], B005z12.iloc[:,5], color = '#3f820c', linewidth = 2, marker = 'o')
...
plt.plot(B005z14.iloc[:,0], B005z14.iloc[:,5], color = '#2f6109', linewidth = 2, marker = 'o')
...
plt.plot(B005z16.iloc[:,0], B005z16.iloc[:,5], color = '#216a00', linewidth = 2, marker = 'o', label = 'B = 0.005 $cm^{-1}$')
...
plt.plot(B005z18.iloc[:,0], B005z18.iloc[:,5], color = '#216a00', linewidth = 2, marker = 'o', label = 'B = 0.005 $cm^{-1}$')
...
plt.plot(B01z02.iloc[:,0], B01z02.iloc[:,5], color = '#fca300', linewidth = 2, marker = 'o')
...
plt.plot(B01z04.iloc[:,0], B01z04.iloc[:,5], color = '#ffcc70', linewidth = 2, marker = 'o')
...
plt.plot(B01z06.iloc[:,0], B01z06.iloc[:,5], color = '#ffbb3f', linewidth = 2, marker = 'o')
...
plt.plot(B01z08.iloc[:,0], B01z08.iloc[:,5], color = '#ffaa0e', linewidth = 2, marker = 'o')
...
plt.plot(B01z1.iloc[:,0], B01z1.iloc[:,5], color = '#dc8e00', linewidth = 2, marker = 'o', label = 'B = 0.01 $cm^{-1}$')
...
plt.plot(B01z12.iloc[:,0], B01z12.iloc[:,5], color = '#dc8e00', linewidth = 2, marker = 'o')
...
plt.plot(B01z14.iloc[:,0], B01z14.iloc[:,5], color = '#ab6e00', linewidth = 2, marker = 'o')
...
plt.plot(B01z16.iloc[:,0], B01z16.iloc[:,5], color = '#fca300', linewidth = 2, marker = 'o', label = 'B = 0.01 $cm^{-1}$')
...
plt.plot(B01z18.iloc[:,0], B01z18.iloc[:,5], color = '#dc8e00', linewidth = 2, marker = 'o', label = 'B = 0.005 $cm^{-1}$')
...
plt.plot(B05z0.iloc[:,0], B05z0.iloc[:,5], color = '#255075', linewidth = 2, marker = 'o')
...
plt.plot(B05z02.iloc[:,0], B05z02.iloc[:,5], color = '#3d84bf', linewidth = 2, marker = 'o')
...
plt.plot(B05z04.iloc[:,0], B05z04.iloc[:,5], color = '#316a9a', linewidth = 2, marker = 'o', label = 'B = 0.05 $cm^{-1}$')
...
plt.plot(B05z06.iloc[:,0], B05z06.iloc[:,5], color = '#255075', linewidth = 2, marker = 'o')
...
plt.plot(B05z08.iloc[:,0], B05z08.iloc[:,5], color = '#193750', linewidth = 2, marker = 'o')
...
plt.plot(B05z1.iloc[:,0][0:2], B05z1.iloc[:,5][0:2], color = '#255075', linewidth = 2, marker = 'o', label = 'B = 0.05 $cm^{-1}$')
...
print((length_of_list_a + length_of_list_b + ((list_c).shape[0]*(list_c).shape[1])))
print((length_of_list_a))
print((length_of_list_b))
print(((list_c).shape[0]*(list_c).shape[1]))
