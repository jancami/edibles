...
Obs_data = pd.read_csv(r"/Users/charmibhatt/Desktop/Local_GitHub/edibles/edibles/utils/simulations/Charmi/fitting methods/5780_fitting/DIB5780_HD185418.txt", sep = ' ')
...
get_rotational_spectrum(x_equal_spacing, B = 0.005, T = 377, delta_B = -0.8, zeta = -0.99, sigma = 0.480, origin =  1.999)
