...
Obs_data = pd.read_csv(r"/Users/charmibhatt/Desktop/Local_GitHub/edibles/edibles/utils/simulations/Charmi/Heather's_data/6614_HD203532.txt", sep = ',')
...
def fit_model(B, T, delta_B, zeta, sigma, origin):
    ...
    result = mod.fit(y_obs_data, params, xx= Obs_data['Wavelength'], weights = 1/0.01)
...
write_results_to_csv(results_list, 'results_203532_with_hotband.csv')     
