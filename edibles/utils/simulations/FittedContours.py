...
class Fitted_Contours:
    ...
    def _residual(self,params, Data_X,Data_Y,Yerr,Jlimit=50,Symmetry_Type=None, Sightline=None ,Q_Branch=False):
        ...
        build=sim(A=A,B=B,C=C,Delta_A=delta*A,Delta_B=delta*B,Delta_C=delta*C,Trot=T,Jlimit=Jlimit, Target=Sightline,lambda0=lambda0,Q_Branch=self.Q_Branch,Q_scale=Q_scale,PR_scale=PR_scale)
