...
# +
#stacking function which takes spectrum data and parameters of peaks and outputs stacked peak (but is not normalising)
...
nonNormalisedLinearStacker(data5000, peakParam)
