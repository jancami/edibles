...
for filename in ListO17: 
	...
	#C6H Bands 1,2:
	subset = sp.getSpectrum(xmin=5250, xmax=5280)
	#C6H Bands 3,4,5:
	...
	#bool_keep2 = (bary_wave > plotrange[0]) & (bary_wave < plotrange[1])
	#plotbary_wave = bary_wave[bool_keep2]
	plt.plot(ism_wave_formula, normsubsetflux, alpha=1, label="ISM Frame {}".format(sp.target))
...
def spectrumO17(filename): 
	...
	#Edibles Data Geocentric Subset Spectrum Plot:
	plt.plot(plotwave, normflux, color='b', alpha=0.9, linewidth=1.0, label="EDIBLES Data {}, GEOCENTRIC RESTFRAME".format(sp.target))
	...
	#bool_keep2 = (bary_wave > plotrange[0]) & (bary_wave < plotrange[1])
	#plotbary_wave = bary_wave[bool_keep2]
	plt.plot(bary_wave, normsubsetflux, color='c', alpha=0.6, linewidth=1.0, label="EDIBLES Data {}, BARYCENTRIC RESTFRAME".format(sp.target))
	...
	#bool_keep2 = (bary_wave > plotrange[0]) & (bary_wave < plotrange[1])
	#plotbary_wave = bary_wave[bool_keep2]
	plt.plot(ism_wave_formula, normsubsetflux, color='k', alpha=1, linewidth=1.5, label="EDIBLES Data {}, ISM CLOUD REST FRAME".format(sp.target))
...
def spectrumO16(filename): 
	...
	# Rescale lab spectrum to plot range
	dynrange = ylim[1]-ylim[0]
	plt.plot(labspec.wavelength, labspec.norm * dynrange/2 + 1, color='lime', alpha=1, linewidth=3.0, label="C6H Spectrum Bands 3,4,5")
...
def spectrumO15(filename): 
	...
	# Rescale lab spectrum to plot range
	dynrange = ylim[1]-ylim[0]
	plt.plot(labspec.wavelength, labspec.norm * dynrange/2 + 1, color='lime', alpha=1, linewidth=3.0, label="C6H Spectrum Bands 6,7,8")
...
def spectrumO14(filename): 
	...
	# Rescale lab spectrum to plot range
	dynrange = ylim[1]-ylim[0]
	plt.plot(labspec.wavelength, labspec.norm * dynrange/2 + 1, color='lime', alpha=1, linewidth=3.0, label="C6H Spectrum Bands 9,10,11,12,13,14")
...
def spectrumO13(filename): 
	...
	# Rescale lab spectrum to plot range
	dynrange = ylim[1]-ylim[0]
	plt.plot(labspec.wavelength, labspec.norm * dynrange/2 + 1, color='lime', alpha=1, linewidth=3.0, label="C6H Spectrum Bands 15,16")
...
def spectrumO12(filename): 
	...
	# Rescale lab spectrum to plot range
	dynrange = ylim[1]-ylim[0]
	plt.plot(labspec.wavelength, labspec.norm * dynrange/2 + 1, color='lime', alpha=1, linewidth=3.0, label="C6H Spectrum Band 17")
...
def spectrumO7(filename): 
	...
	# Rescale lab spectrum to plot range
	dynrange = ylim[1]-ylim[0]
	plt.plot(labspec.wavelength, labspec.norm * dynrange/2 + 1, color='lime', alpha=1, linewidth=3.0, label="C6H Spectrum Band 18")
...
def spectrumO4(filename): 
	...
	# Rescale lab spectrum to plot range
	dynrange = ylim[1]-ylim[0]
	plt.plot(labspec.wavelength, labspec.norm * dynrange/2 + 1, color='lime', alpha=1, linewidth=3.0, label="C6H Spectrum Band 19")
